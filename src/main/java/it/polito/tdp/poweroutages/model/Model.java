...
public class Model {
	...
	public Double totaleOreDisservizio(List<PowerOutage> listaDisservizi) {
		double totale = 0;
	...
	public Double anniCoperti(List<PowerOutage> listaDisservizi) {
		...
		for (int i = 1; i < listaDisservizi.size(); i++) {
			LocalDateTime minLocale = listaDisservizi.get(i).getDateEventBegan();
			LocalDateTime maxLocale = listaDisservizi.get(i).getDateEventFinished();
